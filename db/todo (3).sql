...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2024. Sze 05. 10:53
...
INSERT INTO `feladat` (`userId`, `taskId`, `deadline`, `taskName`, `taskDetail`, `priority`) VALUES
(1, 7, '2024-09-19 00:00:00', 'első', 'nasudiuasbdiuasdibasiudasda', 1),
(1, 8, '2024-09-13 00:00:00', 'teszt2', 'hsaudihsiabdiazsfuasziddsa', 3),
(1, 9, '2024-09-05 09:17:00', 'teszt3', 'nasudhuiashigfasudiasgduas', 3),
(1, 10, '2024-09-06 10:18:00', 'emailfeladat', 'jaijdoiashdoihaspihdadas', 2);
...
(1, 'PMartin', 'panyik.martin@gmail.com', '$2y$10$2p.q9X0X3PK.D.WuPEk8IeqWWAXD3JEw8HYTytJIFmPzPpZz0XiyW'),
...
--
ALTER TABLE `feladat`
  MODIFY `taskId` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
